            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GameId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameOwnerId = table.Column<string>(nullable: true),
                    GameWinnerId = table.Column<string>(nullable: true),
                    GameDate = table.Column<DateTime>(nullable: false),
                    SecretValue = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_AspNetUsers_GameWinnerId",
