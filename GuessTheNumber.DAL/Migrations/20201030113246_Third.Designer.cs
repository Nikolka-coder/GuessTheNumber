...
namespace GuessTheNumber.DAL.Migrations
{
    ...
    [Migration("20201030113246_Third")]
    partial class Third
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuessTheNumber.DAL.Entities.Game", b =>
                {
                    ...
                    b.Property<string>("GameOwnerName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GameWinnerId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("GameWinnerName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SecretValue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GuessTheNumber.DAL.Entities.Attempt", b =>
                {
                    b.HasOne("GuessTheNumber.DAL.Entities.Game", null)
                        .WithMany("Attempts")
            ...
            modelBuilder.Entity("GuessTheNumber.DAL.Entities.Game", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "GameOwnerUser")
                        .WithMany()
                        .HasForeignKey("GameOwnerId");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "GameWinnerUser")
                        .WithMany()
